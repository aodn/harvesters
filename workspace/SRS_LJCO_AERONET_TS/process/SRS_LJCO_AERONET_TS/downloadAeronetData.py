...
def download_aeronetData (aeronetUnZipFolder):
    ...
    html_page = six.moves.urllib.request.urlopen("http://aeronet.gsfc.nasa.gov/cgi-bin/print_warning_opera_v2_new?site=Lucinda&year=110&month=6&day=1&year2=110&month2=6&day2=30&LEV20=1&AVG=10")
    ...
    downloadedFile = six.moves.urllib.request.URLopener()
...
if __name__ == "__main__":
    try:
        import sys,os
        print("Folder Output: " + str(sys.argv[1]))
        aeronetUnZipFolder = str(sys.argv[1])
